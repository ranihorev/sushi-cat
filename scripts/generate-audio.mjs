...
const LETTERS = {
  ...
  B: { arpa: 'B',     word: 'ball',     sound: 'buh' },
  C: { arpa: 'K',     word: 'cat',      sound: 'kuh' },
  D: { arpa: 'D',     word: 'dog',      sound: 'duh' },
  E: { arpa: 'EH1',   word: 'egg',      sound: 'eh' },
  F: { arpa: 'F F F', word: 'fish',     sound: 'fff' },
  G: { arpa: 'G',     word: 'goat',     sound: 'guh' },
  H: { arpa: 'HH HH', word: 'hat',      sound: 'huh' },
  I: { arpa: 'IH1',   word: 'igloo',    sound: 'ih' },
  J: { arpa: 'JH',    word: 'jam',      sound: 'juh' },
  K: { arpa: 'K',     word: 'kite',     sound: 'kuh' },
  ...
  P: { arpa: 'P',     word: 'pizza',    sound: 'puh' },
  Q: { arpa: 'K W',   word: 'queen',    sound: 'kwuh' },
  R: { arpa: 'R R',   word: 'rocket',   sound: 'rrr' },
  S: { arpa: 'S S S', word: 'sun',      sound: 'sss' },
  T: { arpa: 'T',     word: 'tiger',    sound: 'tuh' },
